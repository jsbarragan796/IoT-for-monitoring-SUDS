                  ...
                  <Grid container direction="row" justify="center" alignItems="center" spacing={16}>
                    ...
                    ¿ En qué consiste ?
                      ...
                      <Typography color="secondary" align="justify" variant="h5">
                        MISUDS es un sistema que empodera con internet de las cosas (IoT) el
                        monitoreo de SUDS. A partir de
                        ...
                        están acondicionadas para transmitir datos por medio de SigFox,
                        un proveedor de comunicación especializado en IoT .
                        Una vez los datos llegan al proveedor estos son dirigidos a MISUDS
                  ...
                  <Grid container direction="row" justify="center" alignItems="center" spacing={16}>
                   ...
                   Motivación
                      ...
                      <Typography color="secondary" align="justify" variant="h5">
                        ...
                        El objetivo del monitoreo era determinar el desempeño de las estructuras
                        que lo componen,
                        evaluando la eficiencia de reducción de contaminantes, la disminución de
                        volúmenes y caudales pico de escorrentía. Dicho monitoreo requería que los
                        investigadores tuvieran que
                        desplazarse hasta el lugar para colectar la información manualmente.
                        Con MISUDS se busca que el investigador
                ...
                <Grid item xs={12} sm={12} md={12} lg={10}>
                  ...
                  Funcionalidades
                      ...
                      <Typography color="secondary" align="justify" variant="h5">
                        ...
                        conductividad y precipitación.
                        Cuando el evento termina MISUDS procesa los datos
                        y el evento puede
                        ser consultado en los eventos
                        históricos, los cuales pueden ser fácilmente
                        filtrados. Todos
